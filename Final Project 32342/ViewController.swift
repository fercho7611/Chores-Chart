...
//  Final Project 32342
//
//  Created by Fernando Elizalde on 16/06/23.
//
...
class ViewController: UIViewController {
    ...
    @IBOutlet var Points4: UILabel!
    @IBOutlet var Points5: UILabel!
    @IBOutlet var Points6: UILabel!
    @IBOutlet var Points7: UILabel!
    ...
    @IBAction func tues1(_ sender: Any) {
        count2=count2+1
        print(count2)
        self.Points2.text=String(count2)
    }
    
    @IBAction func tues2(_ sender: Any) {
        count2=count2+1
        print(count2)
        self.Points2.text=String(count2)
    }
    
    @IBAction func tues3(_ sender: Any) {
        count2=count2+1
        print(count2)
        self.Points2.text=String(count2)
    }
    ...
    @IBAction func thur1(_ sender: Any) {
        count4=count4+1
        print(count4)
        self.Points4.text=String(count4)
    }
    
    @IBAction func thur2(_ sender: Any) {
        count4=count4+1
        print(count4)
        self.Points4.text=String(count4)
    }
    
    @IBAction func thur3(_ sender: Any) {
        count4=count4+1
        print(count4)
        self.Points4.text=String(count4)
    }
